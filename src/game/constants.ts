...
export const RECIPES: Record<string, {
  ...
  iron_plate: { id: 'iron_plate', name: 'Iron Plate', inputs: [{ itemId: 'iron', count: 1 }], outputs: [{ itemId: 'iron_plate', count: 1 }], craftTime: 180, energyCost: 1, category: 'smelting' },
  copper_plate: { id: 'copper_plate', name: 'Copper Plate', inputs: [{ itemId: 'copper', count: 1 }], outputs: [{ itemId: 'copper_plate', count: 1 }], craftTime: 180, energyCost: 1, category: 'smelting' },
  steel_plate: { id: 'steel_plate', name: 'Steel Plate', inputs: [{ itemId: 'iron_plate', count: 5 }], outputs: [{ itemId: 'steel_plate', count: 1 }], craftTime: 900, energyCost: 2, category: 'smelting' },
  gear: { id: 'gear', name: 'Gear Wheel', inputs: [{ itemId: 'iron_plate', count: 2 }], outputs: [{ itemId: 'gear', count: 1 }], craftTime: 90, energyCost: 1, category: 'crafting' },
  circuit: { id: 'circuit', name: 'Electronic Circuit', inputs: [{ itemId: 'copper_plate', count: 3 }, { itemId: 'iron_plate', count: 1 }], outputs: [{ itemId: 'circuit', count: 1 }], craftTime: 180, energyCost: 1, category: 'crafting' },
  advanced_circuit: { id: 'advanced_circuit', name: 'Advanced Circuit', inputs: [{ itemId: 'circuit', count: 2 }, { itemId: 'copper_plate', count: 2 }, { itemId: 'plastic', count: 2 }], outputs: [{ itemId: 'advanced_circuit', count: 1 }], craftTime: 360, energyCost: 2, category: 'crafting' },
  battery: { id: 'battery', name: 'Battery', inputs: [{ itemId: 'copper_plate', count: 1 }, { itemId: 'iron_plate', count: 1 }, { itemId: 'sulfuric_acid', count: 2 }], outputs: [{ itemId: 'battery', count: 1 }], craftTime: 540, energyCost: 2, category: 'chemistry' },
  plastic: { id: 'plastic', name: 'Plastic Bar', inputs: [{ itemId: 'coal', count: 1 }, { itemId: 'oil', count: 3 }], outputs: [{ itemId: 'plastic', count: 2 }], craftTime: 180, energyCost: 1, category: 'chemistry' },
  conveyor_belt: { id: 'conveyor_belt', name: 'Conveyor Belt', inputs: [{ itemId: 'iron_plate', count: 1 }, { itemId: 'gear', count: 1 }], outputs: [{ itemId: 'conveyor_belt', count: 2 }], craftTime: 90, energyCost: 0.5, category: 'crafting' },
  inserter_item: { id: 'inserter_item', name: 'Inserter', inputs: [{ itemId: 'iron_plate', count: 1 }, { itemId: 'gear', count: 1 }, { itemId: 'circuit', count: 1 }], outputs: [{ itemId: 'inserter_item', count: 1 }], craftTime: 180, energyCost: 1, category: 'crafting' },
  miner_item: { id: 'miner_item', name: 'Mining Drill', inputs: [{ itemId: 'iron_plate', count: 3 }, { itemId: 'gear', count: 3 }, { itemId: 'circuit', count: 1 }], outputs: [{ itemId: 'miner_item', count: 1 }], craftTime: 360, energyCost: 2, category: 'crafting' },
  furnace_item: { id: 'furnace_item', name: 'Furnace', inputs: [{ itemId: 'stone', count: 5 }, { itemId: 'iron_plate', count: 2 }], outputs: [{ itemId: 'furnace_item', count: 1 }], craftTime: 270, energyCost: 1, category: 'crafting' },
  science_red: { id: 'science_red', name: 'Red Science Pack', inputs: [{ itemId: 'gear', count: 1 }, { itemId: 'copper_plate', count: 1 }], outputs: [{ itemId: 'science_red', count: 1 }], craftTime: 180, energyCost: 1, category: 'crafting' },
  science_green: { id: 'science_green', name: 'Green Science Pack', inputs: [{ itemId: 'conveyor_belt', count: 1 }, { itemId: 'inserter_item', count: 1 }], outputs: [{ itemId: 'science_green', count: 1 }], craftTime: 360, energyCost: 1, category: 'crafting' },
  science_blue: { id: 'science_blue', name: 'Blue Science Pack', inputs: [{ itemId: 'advanced_circuit', count: 1 }, { itemId: 'gear', count: 1 }, { itemId: 'sulfuric_acid', count: 1 }], outputs: [{ itemId: 'science_blue', count: 1 }], craftTime: 900, energyCost: 2, category: 'crafting' },
  sulfuric_acid: { id: 'sulfuric_acid', name: 'Sulfuric Acid', inputs: [{ itemId: 'iron_plate', count: 1 }, { itemId: 'water', count: 2 }, { itemId: 'oil', count: 1 }], outputs: [{ itemId: 'sulfuric_acid', count: 2 }], craftTime: 180, energyCost: 1, category: 'chemistry' },
  ammo: { id: 'ammo', name: 'Firearm Magazine', inputs: [{ itemId: 'iron_plate', count: 4 }], outputs: [{ itemId: 'ammo', count: 1 }], craftTime: 90, energyCost: 1, category: 'military' },
  wall_item: { id: 'wall_item', name: 'Wall', inputs: [{ itemId: 'stone', count: 5 }], outputs: [{ itemId: 'wall_item', count: 1 }], craftTime: 90, energyCost: 0.5, category: 'crafting' },
